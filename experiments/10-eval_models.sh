...
# da (closest)
sbatch_gpu_short "eval_da_0t00s_da_sim" "python3 experiments/13-eval_da_test.py lightning_logs/multicand_0t00s/checkpoints/epoch\=4* --data data/csv/test_multi_sim.csv"
sbatch_gpu_short "eval_da_1t00s_da_sim" "python3 experiments/13-eval_da_test.py lightning_logs/multicand_1t00s/checkpoints/epoch\=4* --data data/csv/test_multi_sim.csv"
sbatch_gpu_short "eval_da_1t10s_da_sim" "python3 experiments/13-eval_da_test.py lightning_logs/multicand_1t10s/checkpoints/epoch\=4* --data data/csv/test_multi_sim.csv"
sbatch_gpu_short "eval_da_1t01s_da_sim" "python3 experiments/13-eval_da_test.py lightning_logs/multicand_1t01s/checkpoints/epoch\=4* --data data/csv/test_multi_sim.csv"
...
sbatch_gpu_short "eval_da_ref_1t00s_da_sim" "python3 experiments/13-eval_da_test.py lightning_logs/multicand_ref_1t00s/checkpoints/epoch\=4* --data data/csv/test_multi_sim.csv" 
sbatch_gpu_short "eval_da_ref_1t01s_da_sim" "python3 experiments/13-eval_da_test.py lightning_logs/multicand_ref_1t01s/checkpoints/epoch\=4* --data data/csv/test_multi_sim.csv" 
sbatch_gpu_short "eval_da_ref_1t10s_da_sim" "python3 experiments/13-eval_da_test.py lightning_logs/multicand_ref_1t10s/checkpoints/epoch\=4* --data data/csv/test_multi_sim.csv" 

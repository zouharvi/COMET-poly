...
sbatch_gpu_bigg "train_multicand_2t00s" "comet-multi-cand-train --cfg comet_multi_cand/configs/experimental/model_multicand_2t00s.yaml" # in training
...
sbatch_gpu_bigg "train_multicand_3t00s" "comet-multi-cand-train --cfg comet_multi_cand/configs/experimental/model_multicand_3t00s.yaml" # in training
sbatch_gpu_bigg "train_multicand_3t30s" "comet-multi-cand-train --cfg comet_multi_cand/configs/experimental/model_multicand_3t30s.yaml" # in training
sbatch_gpu_bigg "train_multicand_3t03s" "comet-multi-cand-train --cfg comet_multi_cand/configs/experimental/model_multicand_3t03s.yaml" # in training

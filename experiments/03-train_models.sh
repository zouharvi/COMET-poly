...
sbatch_gpu_bigg "train_polycand_3t03s" "comet-poly-train --cfg comet_poly/configs/experimental/model_polycand_3t03s.yaml" # failed
# four additional translations
sbatch_gpu_bigg "train_polycand_4t00s" "comet-poly-train --cfg comet_poly/configs/experimental/model_polycand_4t00s.yaml" # todo training
sbatch_gpu_bigg "train_polycand_4t40s" "comet-poly-train --cfg comet_poly/configs/experimental/model_polycand_4t40s.yaml" # todo training
sbatch_gpu_bigg "train_polycand_4t04s" "comet-poly-train --cfg comet_poly/configs/experimental/model_polycand_4t04s.yaml" # todo training
# five additional translations
sbatch_gpu_bigg "train_polycand_5t00s" "comet-poly-train --cfg comet_poly/configs/experimental/model_polycand_5t00s.yaml" # todo training
sbatch_gpu_bigg "train_polycand_5t50s" "comet-poly-train --cfg comet_poly/configs/experimental/model_polycand_5t50s.yaml" # todo training
sbatch_gpu_bigg "train_polycand_5t05s" "comet-poly-train --cfg comet_poly/configs/experimental/model_polycand_5t05s.yaml" # todo training

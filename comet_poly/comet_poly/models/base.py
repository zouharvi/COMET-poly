...
from comet_poly.encoders import str2encoder
from comet_poly.modules import LayerwiseAttention
...
class CometModel(ptl.LightningModule, metaclass=abc.ABCMeta):
    ...
    def predict(
        ...
        if len(scores.shape) == 2 and scores.shape[1] == 1:
            # if we have a single score per sample, remove the second dimension.

...
class PolyCandMetric(RegressionMetric):
    """PolyCandMetric:
    ...
    def __init__(
        ...
        super(RegressionMetric, self).__init__(
            ...
            class_identifier="polycand_metric",
    ...
    def estimate(
        ...
        raise NotImplementedError("Estimate method not implemented for PolyCand. Intentionally not inheriting from RegressionMetric.")
